...
<!-- readme-locale:zh -->
<div align="center">
<img src="./public/logo.svg" alt="ArkHabitat — ARK: Survival Ascended — Creatures" width="64" height="64">
<h1>ArkHabitat — ARK: Survival Ascended — Creatures</h1>
</div>

独立的项目设计文档，适用对象： **ARK: Survival Ascended**。
...
- **本地成长预设** (Local progression presets) — 规划模块，尚未实现。
- **驯服预算工作表** (Taming budget worksheets) — 规划模块，尚未实现。
- **世界恢复清单** (World restore checklist) — 规划模块，尚未实现。
